 ...
 */
public class CreerEventRequest extends StringRequest{

    private static final String API_URL = "http://www-ens.iro.umontreal.ca/~langevip/studyami/api/index.php";
    private Map<String, String> params;

    public CreerEventRequest(String type, String titre, String description, String date, String heure, String lieu, String capacite, String code, Response.Listener<String> listener){
        super(Method.POST, API_URL, listener, null);
        params = new HashMap<>();
        params.put("action_post", "event");
